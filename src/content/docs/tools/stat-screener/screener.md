...
![Иллюстрация к статье screener](/help-assets/screener-1-overview-2.png)
...
Кроме статистики, можно еще довериться фундаментальной оценке связанности цен в паре. В скринере можно выставить фильтр по типу связи, выбрав инструменты, [относящиеся к одной отрасли](/strategies/stat-arbitrage/industry-pair/) и даже уточнить отрасль фильтром по индустрии. Используя фильтр по тикеру, также можно оценить [пары из компаний с общим владельцем](/strategies/stat-arbitrage/common-owner/) или из [обычных и привилегированных акций одной компании](/strategies/stat-arbitrage/ordinary-preferred/).
...
После настройки фильтров и получения списка подходящих пар для уточнения вероятности и прибыльности арбитражной сделки можно по клику на пару перейти в [бэктестер](/tools/stat-screener/backtester/) и изучить её потенциал более продробно.

## Читать далее

- [Как оценить доходность арбитражной сделки с помощью бэктестера](/tools/stat-screener/backtester/)
- [Использование коинтеграции для поиска арбитражных пар](/technique/stat-arbitrage/find-pairs/)
